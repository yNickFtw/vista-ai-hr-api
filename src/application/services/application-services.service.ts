...
@Module({
    ...
    providers: [AuthApplicationService, ExperienceApplicationService, UserApplicationService, SkillApplicationService, AreaApplicationService, CandidateSearchApplicationService],
    exports: [AuthApplicationService, ExperienceApplicationService, UserApplicationService, SkillApplicationService, AreaApplicationService, CandidateSearchApplicationService],
})
